...
batch_size = 64 #number of images to process at a time, then upadates weights (more complicated images require smaller batch sizes)
...
model.compile(optimizer='adam',loss='sparse_categorical_crossentropy', metrics=['accuracy']) #adam optimizer is popular, sparse categorical crossentropy is used for multi-class classification
